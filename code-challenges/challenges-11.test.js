...
// console.log(validatePin('4a34'));
// console.log(validatePin(1234));
// console.log(validatePin('14444'));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const validateEmail = (email) => {
  let reg = /^[a-z0-9]+(\.[a-z0-9]+)?@[a-z0-9]+\.((net)|(com)|(org))$/;
  return reg.test(email);
};

// console.log(validateEmail('justastring.joe@a.com'));
// console.log(validateEmail('a.a@noname.'));
// console.log(validateEmail('joe@codefellows.net'));
// console.log(validateEmail('joe.@'));
// console.log(validateEmail('.schmoe@codefellows.net'));
// console.log(validateEmail('joe.schmoe@.net'));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const validatePhoneNumber = (phoneNumber) => {
  let reg = /^((\([0-9]{3}\)\s?)|([0-9]{3}[\s-]?))[0-9]{3}[\s-]?[0-9]{4}$/;
...
const findTagNames = elements => {
  let reg = /<\/[^< >]*>/g;
  let tags = elements.reduce((acc, v, i) => {
    acc = acc.concat(v.match(reg));
    return acc;
  }, []);
  return tags.map((v, i) => {
...
// console.log(findTagNames(['<h1>Hello, /world!</h1></div>', '<p>Welcome to my site</p>']));
/* ------------------------------------------------------------------------------------------------
TESTS
